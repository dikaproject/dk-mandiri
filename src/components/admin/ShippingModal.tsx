...
import { X, Loader2, Send, Truck } from 'lucide-react';
        ...
        >
          ...
          <div className="p-4">
            <div className="mb-4 bg-gray-50 dark:bg-gray-700 p-3 rounded-md">
              ...
              <p className="text-sm text-gray-700 dark:text-gray-300"><strong>Name:</strong> {recipientName}</p>
              <p className="text-sm text-gray-700 dark:text-gray-300"><strong>Address:</strong> {recipientAddress}</p>
              <p className="text-sm text-gray-700 dark:text-gray-300"><strong>Phone:</strong> {recipientPhone}</p>
            </div>
            ...
            <form onSubmit={handleSubmit}>
              <div className="mb-4">
                ...
                <input
                  ...
                  placeholder="Enter staff name handling this shipment"
